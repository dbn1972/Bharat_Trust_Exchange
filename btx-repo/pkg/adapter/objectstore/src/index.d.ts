...
export interface ObjectStoreAdapter {
    put(bucket: string, key: string, body: Uint8Array, opts?: PutOpts): Promise<{
        etag: string;
        versionId?: string;
    }>;
...
export declare class ObjectStoreError extends Error {
    code: 'not_found' | 'unauth' | 'integrity' | 'provider_error' | 'not_implemented';
    constructor(code: 'not_found' | 'unauth' | 'integrity' | 'provider_error' | 'not_implemented', m: string);
}
