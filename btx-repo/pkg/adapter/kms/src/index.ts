...
export interface KmsAdapter {
  ...
  generateDataKey(keyId: string, opts?: { bits?: 128 | 192 | 256; aad?: string }): Promise<DataKey>;
...
export class KmsError extends Error {
  constructor(public readonly code: 'unauth' | 'not_found' | 'invalid_arg' | 'provider_error' | 'not_implemented',
              message: string,
